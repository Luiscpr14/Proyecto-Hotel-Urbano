...
<body>
    ...
    <nav>
        ...
        <a href="../funciones/logout.php" onclick="return confirm('¿Cerrar sesión de administrador?');">Cerrar Sesi&oacute;n<i class="fa fa-sign-out-alt" style="margin-left:5px;"></i></a>
    </nav>
    <main>
